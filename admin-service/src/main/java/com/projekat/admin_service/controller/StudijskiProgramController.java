...
public class StudijskiProgramController {
    ...
    @GetMapping("/aktivni")
    public ResponseEntity<List<StudijskiProgramDTO>> getAktivne() {
        return ResponseEntity.ok(studijskiProgramService.getAktivni());
    }
    @GetMapping("/neaktivni")
    public ResponseEntity<List<StudijskiProgramDTO>> getNeaktivne() {
        return ResponseEntity.ok(studijskiProgramService.getNeaktivne());
    }
    @GetMapping("/{id}")
