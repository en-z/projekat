...
import org.projekat.dto.StudentDTO;
...
public class StudentMapper {
    ...
    public static StudentDTO toDTO(Student student) {
        ...
        dto.setId(student.getOsoba_id());
        dto.setBrojIndeksa(student.getBrojIndeksa());
        //dto.setGoidnaUpisa(student.getGodinaUpisa());
    ...
    public static Student fromDTO(StudentDTO dto) {
        ...
        student.getOsoba().getUser().setId(dto.getId());
        student.setBrojIndeksa(dto.getBrojIndeksa());
        //student.setGodinaUpisa(dto.getGoidnaUpisa());
